...
(function ($, async) {
    ...
    if (currentPage == PAGE_INVENTORY) {
        ...
        function updateInventoryUI(isOwnInventory) {
            ...
            let buttonsHtml = `
                <a class="btn_green_white_innerfade btn_medium_wide sell_all"><span>售卖所有物品</span></a>
                <a class="btn_green_white_innerfade btn_medium_wide sell_all_duplicates"><span>售卖所有重复物品</span></a>
                <a class="btn_green_white_innerfade btn_medium_wide sell_selected" style="display:none"><span>售卖选定物品</span></a>
                <a class="btn_green_white_innerfade btn_medium_wide sell_manual" style="display:none"><span>手动售卖</span></a>
            `;
            ...
            if (showMiscOptions) {
                ...
                buttonsHtml += '<a class="btn_green_white_innerfade btn_medium_wide sell_all_crates"><span>售卖所有箱子</span></a>';
            }
